...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*
        val callBack = { fontSize : Float -> displayTextView.textSize = fontSize*10}
        ...
        recyclerView.adapter = NumberDisplayAdapter(numbers){fontSize : Float -> displayTextView.textSize = fontSize*10}
